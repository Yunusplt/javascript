...
//todo += yaptik alt alta bassin diye her ürünün cardini. yani önce basilanlar kalsin siradakini ekle.
    document.querySelector("#urun-rowlari").innerHTML += `
...
//? browserda en alttaki total kisminin table.
...
document.querySelector(".toplam").textContent =
  (araToplam + (araToplam * 0.18)+15.0).toFixed(2)
