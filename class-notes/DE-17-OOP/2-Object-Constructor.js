...
Book.prototype.findYear = function () {
    return 2023 - this.year
}

//?prototype book2 de yer kaplamadı ama çağırınca geldi
console.log(book2.findYear());
...
const dergi1 = new Dergi("yaprak dokumu", "resut nuri", 1980, "eylül")
