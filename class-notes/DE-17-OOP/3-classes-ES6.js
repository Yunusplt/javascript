...
//? Aslinda  class keyword ü  ES6 da tanitilmiştir, but is syntactical sugar (yalnizca dili kullanmanin bazi yönlerini daha kolay ve genel olarak daha keyifli hale getirmek için eklenen bir dil özelliği için kullanilan bir terimdir.), JavaScript  prototype-based dir.
...
const dergi1 = new Dergi("kasagi", "Omer Seyfettin", 1932, "aralik");
...
console.log(f);
//! extends edildiği zaman, atadan gelen her veriyi kullanmak zorundayiz, en fazla value kismini boş " " birakabiliriz